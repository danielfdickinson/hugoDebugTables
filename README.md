...
See the new [hugo-debug-tables](https://github.com/danielfdickinson/hugo-debug-tables) for current development.
...
See [License](https://github.com/danielfdickinson/hugoDebugTables/blob/master/LICENSE) for permissions on use.
